...
public class curtain_flipper extends Activity implements View.OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Log.d("came	00", "sad");
		setContentView(R.layout.curtain_flipper);
		setvars();
		setlisteners();
	...
	private boolean getsec() {
		...
		try {
			...
			Toast.makeText(curtain_flipper.this,
