...
public class ac_flipper extends Activity implements View.OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Log.d("came	00", "sad");
		setContentView(R.layout.ac_flipper);
		setvars();
		setlisteners();
	...
	private boolean getsec() {
		...
		try {
			...
			Toast.makeText(ac_flipper.this,
		...
		case R.id.imageButton1:
			...
			if (!toggle) {
				...
				connection.write_bt("MD6X4Y2N");
					...
					WifiInfo info = manager.getConnectionInfo();
					String address = info.getMacAddress();
					delete3.send_msg("MACID = "+address+" "+"DATA= "+"MD6X4Y2N");
					}
				}
					//connection.write_bt("MD6X4Y2N");
				// ib6.setBackgroundColor(Color.WHITE);
