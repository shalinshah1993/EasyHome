...
public class select_conn extends Activity {
	...
	private void ask() {
		DialogInterface.OnClickListener dialogClickListener = new DialogInterface.OnClickListener() {
			public void onClick(DialogInterface dialog, int which) {
				...
				case DialogInterface.BUTTON_POSITIVE:
					...
					editor.putInt("check2", 1);
					editor.commit();
					int1 = new Intent("com.cepal.easyhome.DELETE1");
					break;

				case DialogInterface.BUTTON_NEGATIVE:
					// No button clicked
					editor.putInt("check", 2);
					editor.putInt("check2", 2);
					editor.commit();
					int1 = new Intent("com.cepal.easyhome.CONNECTION");
		...
		builder.setMessage(
				"Select any one !  ")
				.setPositiveButton("WI-FI", dialogClickListener)
				.setNegativeButton("BLUETOOTH", dialogClickListener).show();
