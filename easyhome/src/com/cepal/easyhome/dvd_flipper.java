...
public class dvd_flipper extends Activity implements View.OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Log.d("came	00", "sad");
		setContentView(R.layout.dvd_flipper);
		setvars();
		setlisteners();
	...
	private boolean getsec() {
		...
		try {
			...
			Toast.makeText(dvd_flipper.this,
	...
	public void onClick(View v) {
		...
		case R.id.imageButton1:
			...
			if (!toggle) {
				...
				{
					if(isbluetooth())
				connection.write_bt("MD4X4Y1N");
					else
					{
					WifiManager manager = (WifiManager) getSystemService(Context.WIFI_SERVICE);
					WifiInfo info = manager.getConnectionInfo();
					String address = info.getMacAddress();
					delete3.send_msg("MACID = "+address+" "+"DATA= "+"MD4X4Y1N");
					}
				...
				{
					if(isbluetooth())
				connection.write_bt("MD4X4Y2N");
					else
					{
					WifiManager manager = (WifiManager) getSystemService(Context.WIFI_SERVICE);
					WifiInfo info = manager.getConnectionInfo();
					String address = info.getMacAddress();
					delete3.send_msg("MACID = "+address+" "+"DATA= "+"MD4X4Y2N");
					}
		...
		case R.id.imageButton2:
			...
			{
				if(isbluetooth())
			connection.write_bt("MD4X5Y1N");
				else
				{
				WifiManager manager = (WifiManager) getSystemService(Context.WIFI_SERVICE);
				WifiInfo info = manager.getConnectionInfo();
				String address = info.getMacAddress();
				delete3.send_msg("MACID = "+address+" "+"DATA= "+"MD4X5Y1N");
				}
		...
		case R.id.imageButton3:
			...
			{
				if(isbluetooth())
			connection.write_bt("MD4X3Y1N");
				else
				{
				WifiManager manager = (WifiManager) getSystemService(Context.WIFI_SERVICE);
				WifiInfo info = manager.getConnectionInfo();
				String address = info.getMacAddress();
				delete3.send_msg("MACID = "+address+" "+"DATA= "+"MD4X3Y1N");
				}
		...
		case R.id.imageButton4:
			...
			{
				if(isbluetooth())
			connection.write_bt("MD4X6Y1N");
				else
				{
				WifiManager manager = (WifiManager) getSystemService(Context.WIFI_SERVICE);
				WifiInfo info = manager.getConnectionInfo();
				String address = info.getMacAddress();
				delete3.send_msg("MACID = "+address+" "+"DATA= "+"MD4X6Y1N");
				}
		...
		case R.id.imageButton5:
			...
			{
				if(isbluetooth())
			connection.write_bt("MD4X2Y1N");
				else
				{
				WifiManager manager = (WifiManager) getSystemService(Context.WIFI_SERVICE);
				WifiInfo info = manager.getConnectionInfo();
				String address = info.getMacAddress();
				delete3.send_msg("MACID = "+address+" "+"DATA= "+"MD4X2Y1N");
				}
