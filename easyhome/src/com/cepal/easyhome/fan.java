...
public class fan extends Activity implements View.OnClickListener {
	...
	public void onClick(View v) {
		...
		case R.id.imageButton2:
			...
			/*
			 * Log.d("1", "here"); ib2.setBackgroundColor(Color.RED);
			 * 
			 * Log.d("2", "here");
			 * 
			 * try { Thread.sleep(3000); } catch (InterruptedException e) { //
			 * TODO Auto-generated catch block e.printStackTrace(); }
			 * //timer1.start(); Log.d("3", "here");
			 * ib2.setBackgroundColor(Color.MAGENTA); Log.d("4", "here");
			 */
			break;
